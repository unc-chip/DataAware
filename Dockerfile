...
LABEL io.k8s.description="DataAware Jupyter Notebook Online Training Modules" \
 io.k8s.display-name="DataAware Jupyter Notebook Online Training Modules" \
...
RUN wget --no-check-certificate -O /home/notebook_user/master.zip https://github.com/unc-chip/DataAware/archive/master.zip
...
RUN echo "c.NotebookApp.password = 'sha1:d668c77d540b:573a3d50d0192415f7b7e7112ecd5e462b25b254'"  >> /home/notebook_user/.jupyter/jupyter_notebook_config.py
